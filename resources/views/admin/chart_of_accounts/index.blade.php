            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-content-center justify-content-between">
                        <h3 class="font-weight-bold text-xl">Data Chart Of Account</h3>
                        <div class="d-flex align-items-center">
                            ...
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalForm">
                                <i class="bi bi-plus-lg"></i> Tambah Chart Of Account
                            </button>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered data-table no-footer dtr-inline  ">
                            <thead>
                                <tr>
                                    <th width="50px">No</th>
                                    <th>Code</th>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="type" name="type">
                                        ...
                                        <option value="expnese">Expense</option>
                                    </select>
...
@push('scripts')
    <script>
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url, method;
            if (primaryId) {
                url = "{{ route('chart-of-accounts.update', ':id') }}".replace(':id', primaryId);
                method = 'PUT';
            } else {
            ...
            $.ajax({
                ...
                success: function(response) {
                    audio.play();
                    let msg = primaryId ?
                        "Data Chart Of Accounts berhasil diperbarui" :
                        "Data Chart Of Accounts berhasil ditambahkan";
        ...
        $(document).on('click', '.editBtn', function() {
            ...
            let url = $(this).data('url'); // route('coa.edit', id)
            ...
            $.get(url, function(response) {
                ...
                if (response.status === 'success') {
                    ...
                    // Rubah title modal menjadi edit
                    $('#modalTitle').text("Edit Chart Of Account");
        ...
        $(document).on('click', '.deleteBtn', function(e) {
            ...
            Swal.fire({
                title: 'Yakin hapus?',
                text: 'Data Chart Of Account akan dihapus permanen.',
                icon: 'warning',
