            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-content-center justify-content-between">
                        <h3 class="font-weight-bold text-xl">Data Departments</h3>
                        <div class="d-flex align-items-center">
                            ...
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalForm">
                                <i class="bi bi-plus-lg"></i> Tambah Departments
                            </button>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '#btnTambah', function() {
            $('#modalFormLabel').text("Tambah Departments");
        });
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url, method;
            if (primaryId) {
                url = "{{ route('departments.update', ':id') }}".replace(':id', primaryId);
                method = 'PUT';
            } else {
            ...
            $.ajax({
                ...
                success: function(response) {
                    audio.play()
                    let msg = primaryId ?
                        "Data Department berhasil diperbarui" :
                        "Data Department berhasil ditambahkan";
